...
namespace Rush.EditorTools
{
    ...
    public static class RushSetupActions
    {
        ...
        /// <summary>
        /// 웨이브별 적 스탯 배수 (체력/공격력/킬 보상). 계단식 값이며 방어 단계에는 적용하지 않는다.
        /// 1~6 = 1.0, 7~12 = 1.25, 13~18 = 1.75, 19~24 = 3.5.
        /// 뒤 두 구간은 후반 압박을 올리려고 시트값(1.5 / 2.0)에서 상향한 값이다 (2026-08-10).
        /// </summary>
        static readonly float[] WaveMultipliers =
        {
            1.00f, 1.00f, 1.00f, 1.00f, 1.00f, 1.00f, 1.25f, 1.25f, 1.25f, 1.25f, 1.25f, 1.25f,
            1.75f, 1.75f, 1.75f, 1.75f, 1.75f, 1.75f, 3.50f, 3.50f, 3.50f, 3.50f, 3.50f, 3.50f,
        };
